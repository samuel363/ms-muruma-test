 ...
 */
@AnalyzeClasses(packages = "com.muruma", importOptions = ImportOption.DoNotIncludeTests.class)
public class RulesTest {
    ...
    public static final ArchRule layer_dependencies = Architectures.layeredArchitecture().consideringOnlyDependenciesInLayers()
            ...
            .layer(CONFIG).definedBy("com.muruma.config..")
            .layer(DOMAIN).definedBy("com.muruma.domain..")
            .layer(ADAPTER).definedBy("com.muruma.adapter..")
            .layer(APPLICATION).definedBy("com.muruma.application..")
